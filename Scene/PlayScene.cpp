...
void PlayScene::ConstructUI() {
    ...
    btn = new TurretButton("play/floor.png", "play/dirt.png",
		...
		Engine::Sprite("play/turret-4.png", 1446, 136, 0, 0, 0, 0)
		, 1446, 136, NewTurret::Price);
...
// void PlayScene::RecordScore(int score) {
//     std::string filename = "../Resource/scoreboard.txt";
//     std::ofstream recordFile(filename, std::ios::app);
//     if (recordFile.is_open()) {
//         // Get current time.
//         std::time_t now = std::time(nullptr);
//         char timestamp[100];
//         std::strftime(timestamp, sizeof(timestamp), "%Y-%m-%d %H:%M:%S", std::localtime(&now));
//         recordFile << score << " , " << timestamp << "\n";
//         recordFile.close();
//     } else {
